...
%\usepackage[russian,english]{polyglossia}
\usepackage{lmodern}
...
% affiliations
\author{
\IEEEauthorblockN{Солдатов Д.В.}
\IEEEauthorblockA{СПБГУ}
\and
\IEEEauthorblockN{Вахитов А.Т.}
\IEEEauthorblockA{СПБГУ}}
...
\begin{figure}[h]
	\centering
		\includegraphics[keepaspectratio,width=\columnwidth]{E:/Downloads/_Study/DynTrack/TestTrackingOCV/text/images/rgbd.kinect/000757.png}
	\label{fig:000757}
\end{figure}
...
\begin{figure}[h]
	\centering
		\includegraphics[keepaspectratio,width=\columnwidth]{images/sua/687.png}
	\label{fig:000757}
\end{figure}
